...
public class Fruitgame : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (currentFruit != null)
        {
            ...
            Vector3 newPosition = new Vector3(worldPosition.x, fruitStartHeigt, 0);
    ...
    void SpawnnewFruit()
    {
        if (!isGameOver)
        {
            ...
            currentFruit.transform.position = new Vector3(fruitSize[currentFruitType], fruitSize[currentFruitType], 1);
